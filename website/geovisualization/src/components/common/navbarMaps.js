...
export default function PrimarySearchAppBar() {
  ...
  return (
    <div className={classes.grow}>
      <AppBar position="static"  style={{ background: '#0B0A20' , paddingLeft:'250px'}}>
        <Toolbar>
          <NavButton style={{paddingLeft: '100px'}}>
            <NavLink to="/">
              <h3>Thailand’s Travel Guide</h3>
            </NavLink>
          </NavButton>
          <div className={classes.grow} />
          <div className={classes.sectionDesktop} style={{paddingRight: '0px'}}>
            <NavButton>
              <NavLink to="/">
                HOME
              </NavLink>
